...
$snippets[0]->fromArray(array(
    ...
    'name' => 'gridClassKeyNumChildrenField',
    'description' => 'Example of a snippet for field on grid',
    'snippet' => getSnippetContent($sources['source_core'] . '/elements/snippets/gridclasskeynumchildrenfield.snippet.php'),
        ), '', true, true);
